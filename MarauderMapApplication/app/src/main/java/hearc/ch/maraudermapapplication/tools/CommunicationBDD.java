...
public class CommunicationBDD
{
    ...
    public static int insertNewMap(String url, Map<String, String> kvPairs, File file) throws IOException
    {
        int code = -1;
        HttpEntity entity = doPost(url, kvPairs, file).getEntity();
    ...
    public static void insertNewBeacon(String url, Map<String, String> kvPairs, File file) throws IOException
    {
        HttpEntity entity = doPost(url, kvPairs, null).getEntity();
